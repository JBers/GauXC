...
template<bool is_trial>
void AoSScheme1Base::eval_xmat_dks_impl( double fac, XCDeviceData* _data, bool do_grad, density_id den_select ){
  ...
  if (den_select == DEN_S) {
      ...
      dmat_ptr_SS_j   = static_stack.den_selector(DEN_X_SS_IM);
      dmat_ptr_SS_i   = static_stack.den_selector(DEN_Y_SS_IM);
  }
  if (den_select == DEN_Z) {
